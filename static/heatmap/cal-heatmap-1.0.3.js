function calendarHeatmap() {
  ...
  function chart() {
    ...
    var monthRange = ((d3.time && d3.time.months) || d3.timeMonths)(
      moment(yearAgo).startOf("month").toDate(),
      now
    ...
    function drawChart() {
      ...
      if (chart.legendEnabled()) {
        ...
        legendGroup
          ...
          .attr(
            "x",
            width - width + SQUARE_PADDING + (colorRange.length + 1) * 15
          )
          .attr("y", height + SQUARE_LENGTH)
          .text(locale.More);
      }
